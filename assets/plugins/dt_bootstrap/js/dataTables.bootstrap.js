$.extend(
				...
				{
					"sDom" : "<'row'<'col-xs-12 col-sm-6 col-lg-6 col-md-6'l><'col-xs-12 col-sm-6 col-lg-6 col-md-6'f>r>"
							+ "t"
							+ "<'row'<'col-xs-12 col-sm-6 col-lg-6 col-md-6'i><'col-xs-12 col-sm-6 col-lg-6 col-md-6'p>>",
					"oLanguage" : {
						"sLengthMenu" : "_MENU_ <div class='col-xs-12 col-sm-6 col-md-6 col-lg-6'><p class='help help-block'>records per page</p></div>"
					}
				});
$
		.extend(
				$.fn.dataTableExt.oStdClasses,
				{
					...
					"sLengthSelect" : "col-xs-12 col-sm-6 col-lg-6 col-md-6 form-control input-sm"
				});
if ($.fn.dataTable.Api) {
	...
	$.fn.dataTable.ext.renderer.pageButton.bootstrap = function(settings, host,
		...
		attach($(host).empty().html('<ul class="pagination pagination-sm"/>')
				.children('ul'), buttons);
	}
} else {
