$.extend(true,$.fn.dataTable.defaults,{"sDom":"<'row'<'col-xs-12 col-sm-6 col-lg-6 col-md-6'l><'col-xs-12 col-sm-6 col-lg-6 col-md-6'f>r>"+"t"+"<'row'<'col-xs-12 col-sm-6 col-lg-6 col-md-6'i><'col-xs-12 col-sm-6 col-lg-6 col-md-6'p>>","oLanguage":{"sLengthMenu":"_MENU_ <div class='col-xs-12 col-sm-6 col-md-6 col-lg-6'><p class='help help-block'>records per page</p></div>"}});$.extend($.fn.dataTableExt.oStdClasses,{"sWrapper":"dataTables_wrapper form-inline","sFilterInput":"form-control input-sm","sLengthSelect":"col-xs-12 col-sm-6 col-lg-6 col-md-6 form-control input-sm"});if($.fn.dataTable.Api){$.fn.dataTable.defaults.renderer='bootstrap';$.fn.dataTable.ext.renderer.pageButton.bootstrap=function(settings,host,idx,buttons,page,pages){var api=new $.fn.dataTable.Api(settings);var classes=settings.oClasses;var lang=settings.oLanguage.oPaginate;var btnDisplay,btnClass;var attach=function(container,buttons){var i,ien,node,button;var clickHandler=function(e){e.preventDefault();if(e.data.action!=='ellipsis'){api.page(e.data.action).draw(false);}};for(i=0,ien=buttons.length;i<ien;i++){button=buttons[i];if($.isArray(button)){attach(container,button);}
